...
@bs.module("react")
external forwardRef: (@bs.uncurry ('props, Js.Nullable.t<ref<'a>>) => element) => component<
  'props,
> = "forwardRef"
 ...
 */
@bs.module("react")
external useState: (@bs.uncurry (unit => 'state)) => ('state, ('state => 'state) => unit) =
  "useState"
...
@bs.module("react")
external useEffect0: (@bs.uncurry (unit => option<unit => unit>), @bs.as(json`[]`) _) => unit =
  "useEffect"
@bs.module("react")
...
@bs.module("react")
external useEffect3: (@bs.uncurry (unit => option<unit => unit>), ('a, 'b, 'c)) => unit =
  "useEffect"
@bs.module("react")
external useEffect4: (@bs.uncurry (unit => option<unit => unit>), ('a, 'b, 'c, 'd)) => unit =
  "useEffect"
@bs.module("react")
external useEffect5: (@bs.uncurry (unit => option<unit => unit>), ('a, 'b, 'c, 'd, 'e)) => unit =
  "useEffect"
@bs.module("react")
external useEffect6: (
...
@bs.module("react")
external useLayoutEffect1: (@bs.uncurry (unit => option<unit => unit>), array<'a>) => unit =
  "useLayoutEffect"
@bs.module("react")
external useLayoutEffect2: (@bs.uncurry (unit => option<unit => unit>), ('a, 'b)) => unit =
  "useLayoutEffect"
@bs.module("react")
external useLayoutEffect3: (@bs.uncurry (unit => option<unit => unit>), ('a, 'b, 'c)) => unit =
  "useLayoutEffect"
@bs.module("react")
external useLayoutEffect4: (@bs.uncurry (unit => option<unit => unit>), ('a, 'b, 'c, 'd)) => unit =
  "useLayoutEffect"
@bs.module("react")
...
@bs.module("react")
external useMemo0: (@bs.uncurry (unit => 'any), @bs.as(json`[]`) _) => 'any = "useMemo"
...
external useCallback0: (
  @bs.uncurry ('input => 'output),
  @bs.as(json`[]`) _,
) => callback<'input, 'output> = "useCallback"

@bs.module("react")
external useCallback1: (@bs.uncurry ('input => 'output), array<'a>) => callback<'input, 'output> =
  "useCallback"

@bs.module("react")
external useCallback2: (@bs.uncurry ('input => 'output), ('a, 'b)) => callback<'input, 'output> =
  "useCallback"
...
module Uncurried = {
  ...
  @bs.module("react")
  external useCallback: (@bs.uncurry ('input => 'output)) => callback<'input, 'output> =
    "useCallback"
